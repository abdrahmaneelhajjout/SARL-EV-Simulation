...
public interface GetLocation extends Capacity {
  @Pure
   ...
   * @ExcludeFromApidoc
   */
  class ContextAwareCapacityWrapper<C extends GetLocation> extends Capacity.ContextAwareCapacityWrapper<C> implements GetLocation {
