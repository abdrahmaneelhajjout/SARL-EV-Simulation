...
public class AutoAgent extends VehiculeAgent {
  ...
  @SyntheticMember
  public AutoAgent(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public AutoAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
