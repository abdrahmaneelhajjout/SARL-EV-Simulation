...
public class LightAgent extends Agent {
  ...
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    ...
    this.lightStatus = ((LightStatus) _get_1);
  ...
  @Pure
  protected LightStatus getStatus() {
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    LightAgent other = (LightAgent) obj;
  ...
  @SyntheticMember
  public LightAgent(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public LightAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
