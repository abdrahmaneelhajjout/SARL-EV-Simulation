...
public class MotorAgent extends VehiculeAgent {
  ...
  @SyntheticMember
  public MotorAgent(final UUID parentID, final UUID agentID) {
    super(parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public MotorAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
