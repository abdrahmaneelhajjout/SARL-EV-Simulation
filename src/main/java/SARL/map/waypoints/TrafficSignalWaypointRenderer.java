...
public class TrafficSignalWaypointRenderer implements WaypointRenderer<TrafficSignalWaypoint>{
    
	@Override
    public void paintWaypoint(Graphics2D g, JXMapViewer viewer, TrafficSignalWaypoint w) {
