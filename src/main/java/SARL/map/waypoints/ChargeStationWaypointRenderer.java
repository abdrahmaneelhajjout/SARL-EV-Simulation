...
public class ChargeStationWaypointRenderer implements WaypointRenderer<ChargeStationWaypoint>{
    
	@Override
    public void paintWaypoint(Graphics2D g, JXMapViewer viewer, ChargeStationWaypoint w) {
