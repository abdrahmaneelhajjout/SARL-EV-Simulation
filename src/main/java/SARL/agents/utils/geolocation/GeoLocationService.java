...
import SARL.agents.utils.geolocation.overpass.Element;
import SARL.agents.utils.geolocation.overpass.HaversineDistance;
import SARL.agents.utils.geolocation.overpass.Node;
import SARL.agents.utils.geolocation.overpass.NodesResponseData;
import SARL.agents.utils.geolocation.overpass.Way;
import SARL.agents.utils.geolocation.overpass.WaysResponseData;
import static SARL.agents.utils.geolocation.overpass.HaversineDistance.haversine;;
...
public class GeoLocationService {
	...
	public static Pair<SARL.agents.utils.geolocation.mapbox.Node, SARL.agents.utils.geolocation.mapbox.Node> getRandomStartAndDestination(
			SARL.agents.utils.geolocation.mapbox.Node radius_center_location, double radiusKm) {
		...
		SARL.agents.utils.geolocation.mapbox.Node start = new SARL.agents.utils.geolocation.mapbox.Node(startLat, startLong);
		SARL.agents.utils.geolocation.mapbox.Node destination = new SARL.agents.utils.geolocation.mapbox.Node(endLat, endLong);
		return new Pair<>(start, destination);
	}

	public static List<SARL.agents.utils.geolocation.mapbox.Node> getTrafficSignsFromOverpass(SARL.agents.utils.geolocation.mapbox.Node radius_center_location, int radiusInKM)
			throws IOException {
		// Create the Jackson ObjectMapper
		ObjectMapper mapper = new ObjectMapper();
	...
	public static Optional<List<? extends Element>> getWaysAsWaysListWithinRadius(SARL.agents.utils.geolocation.mapbox.Node radius_center_location,double radiusInKM) throws IOException {
		// Create the Jackson ObjectMapper
		ObjectMapper mapper = new ObjectMapper();
	...
	public static Node getRandomNodeFromWayWithinRadius(SARL.agents.utils.geolocation.mapbox.Node radius_center_location, double radiusInKM) throws IOException {
		// Get ways within the radius
